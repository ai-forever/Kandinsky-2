...
class DDIMSampler(object):
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="uniform", ddim_eta=0., verbose=True, init_step=None):
        ...
        self.register_buffer('betas', to_torch(torch.from_numpy(self.old_diffusion.betas)))
        self.register_buffer('alphas_cumprod', to_torch(alphas_cumprod))
        self.register_buffer('alphas_cumprod_prev', to_torch(torch.from_numpy(self.old_diffusion.alphas_cumprod_prev)))
    ...
    def sample(self,
        ...
        self.make_schedule(ddim_num_steps=S, ddim_eta=eta, verbose=verbose, init_step=init_step)
        # sampling
        C, H, W = shape
